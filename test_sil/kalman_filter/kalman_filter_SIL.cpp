#include "kalman_filter_SIL_wrapper.hpp"
...
using FLOAT = typename kalman_filter_SIL_wrapper::type::Value_Type;

constexpr std::size_t INPUT_SIZE = kalman_filter_SIL_wrapper::INPUT_SIZE;
constexpr std::size_t STATE_SIZE = kalman_filter_SIL_wrapper::STATE_SIZE;
constexpr std::size_t OUTPUT_SIZE = kalman_filter_SIL_wrapper::OUTPUT_SIZE;

kalman_filter_SIL_wrapper::type kf;

void initialize(void) { kf = kalman_filter_SIL_wrapper::make(); }

void predict_and_update(py::array_t<FLOAT> U_in, py::array_t<FLOAT> Y_in) {
